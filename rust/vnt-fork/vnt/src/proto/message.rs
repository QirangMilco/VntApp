...
pub struct RegistrationRequest {
    ...
    // @@protoc_insertion_point(field:RegistrationRequest.client_secret_hash)
    pub client_secret_hash: ::std::vec::Vec<u8>,
    // special fields
...
impl RegistrationRequest {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "client_secret_hash",
            |m: &RegistrationRequest| { &m.client_secret_hash },
            |m: &mut RegistrationRequest| { &mut m.client_secret_hash },
        ));
...
impl ::protobuf::Message for RegistrationRequest {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                74 => {
                    self.client_secret_hash = is.read_bytes()?;
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.client_secret_hash.is_empty() {
            my_size += ::protobuf::rt::bytes_size(9, &self.client_secret_hash);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
        self.special_fields.cached_size().set(my_size as u32);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.client_secret_hash.is_empty() {
            os.write_bytes(9, &self.client_secret_hash)?;
        }
        os.write_unknown_fields(self.special_fields.unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn default_instance() -> &'static RegistrationRequest {
        static instance: RegistrationRequest = RegistrationRequest {
            ...
            client_secret: false,
            client_secret_hash: ::std::vec::Vec::new(),
            special_fields: ::protobuf::SpecialFields::new(),
        };
        &instance
    }
...
pub struct DeviceInfo {
    ...
    pub client_secret: bool,
    // @@protoc_insertion_point(field:DeviceInfo.client_secret_hash)
    pub client_secret_hash: ::std::vec::Vec<u8>,
...
impl DeviceInfo {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "client_secret_hash",
            |m: &DeviceInfo| { &m.client_secret_hash },
            |m: &mut DeviceInfo| { &mut m.client_secret_hash },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "wireguard",
...
impl ::protobuf::Message for DeviceInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.client_secret_hash.is_empty() {
            my_size += ::protobuf::rt::bytes_size(5, &self.client_secret_hash);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.client_secret_hash.is_empty() {
            os.write_bytes(5, &self.client_secret_hash)?;
        }
        if self.wireguard != false {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ret\x12\x1d\n\nkey_finger\x18\x03\x20\x01(\tR\tkeyFinger\"\x83\x01\n\x11\
    HandshakeResponse\x12\x18\n\x07version\x18\x01\x20\x01(\tR\x07version\
    \x12\x16\n\x06secret\x18\x02\x20\x01(\x08R\x06secret\x12\x1d\n\npublic_k\
    ey\x18\x03\x20\x01(\x0cR\tpublicKey\x12\x1d\n\nkey_finger\x18\x04\x20\
    \x01(\tR\tkeyFinger\"@\n\x16SecretHandshakeRequest\x12\x14\n\x05token\
    \x18\x01\x20\x01(\tR\x05token\x12\x10\n\x03key\x18\x02\x20\x01(\x0cR\x03\
    ...
    \x04\x20\x01(\x08R\x06isFast\x12\x18\n\x07version\x18\x05\x20\x01(\tR\
    \x07version\x12\x1d\n\nvirtual_ip\x18\x06\x20\x01(\x07R\tvirtualIp\x12&\
    \n\x0fallow_ip_change\x18\x07\x20\x01(\x08R\rallowIpChange\x12#\n\rclien\
    t_secret\x18\x08\x20\x01(\x08R\x0cclientSecret\x12,\n\x12client_secret_h\
    ash\x18\t\x20\x01(\x0cR\x10clientSecretHash\"\xb3\x02\n\x14RegistrationR\
    esponse\x12\x1d\n\nvirtual_ip\x18\x01\x20\x01(\x07R\tvirtualIp\x12'\n\
    \x0fvirtual_gateway\x18\x02\x20\x01(\x07R\x0evirtualGateway\x12'\n\x0fvi\
    rtual_netmask\x18\x03\x20\x01(\x07R\x0evirtualNetmask\x12\x14\n\x05epoch\
    \x18\x04\x20\x01(\rR\x05epoch\x125\n\x10device_info_list\x18\x05\x20\x03\
    (\x0b2\x0b.DeviceInfoR\x0edeviceInfoList\x12\x1b\n\tpublic_ip\x18\x06\
    \x20\x01(\x07R\x08publicIp\x12\x1f\n\x0bpublic_port\x18\x07\x20\x01(\rR\
    \npublicPort\x12\x1f\n\x0bpublic_ipv6\x18\x08\x20\x01(\x0cR\npublicIpv6\
    \"\xd5\x01\n\nDeviceInfo\x12\x12\n\x04name\x18\x01\x20\x01(\tR\x04name\
    \x12\x1d\n\nvirtual_ip\x18\x02\x20\x01(\x07R\tvirtualIp\x12#\n\rdevice_s\
    tatus\x18\x03\x20\x01(\rR\x0cdeviceStatus\x12#\n\rclient_secret\x18\x04\
    \x20\x01(\x08R\x0cclientSecret\x12,\n\x12client_secret_hash\x18\x05\x20\
    \x01(\x0cR\x10clientSecretHash\x12\x1c\n\twireguard\x18\x06\x20\x01(\x08\
    R\twireguard\"Y\n\nDeviceList\x12\x14\n\x05epoch\x18\x01\x20\x01(\rR\x05\
    epoch\x125\n\x10device_info_list\x18\x02\x20\x03(\x0b2\x0b.DeviceInfoR\
    \x0edeviceInfoList\"\x84\x03\n\tPunchInfo\x12$\n\x0epublic_ip_list\x18\
    ...
    pe\x18\x05\x20\x01(\x0e2\r.PunchNatTypeR\x07natType\"$\n\tRouteItem\x12\
