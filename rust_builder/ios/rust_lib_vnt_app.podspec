...
# Run `pod lib lint rust_lib_vnt_app.podspec` to validate before publishing.
#
Pod::Spec.new do |s|
  s.name             = 'rust_lib_vnt_app'
  s.version          = '0.0.1'
...
A new Flutter FFI plugin project.
  ...
  s.script_phase = {
    ...
    :output_files => ["${BUILT_PRODUCTS_DIR}/librust_lib_vnt_app.a"],
  }
  s.pod_target_xcconfig = {
    'DEFINES_MODULE' => 'YES',
    # Flutter.framework does not contain a i386 slice.
    'EXCLUDED_ARCHS[sdk=iphonesimulator*]' => 'i386',
    'OTHER_LDFLAGS' => '-force_load ${BUILT_PRODUCTS_DIR}/librust_lib_vnt_app.a',
  }
end